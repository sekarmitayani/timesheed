...
export function PMDashboardHeader({ userName, activeProjectsCount }: PMDashboardHeaderProps) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-slate-500">
                    You are managing <span className="font-bold text-[#4B7BEC]">{activeProjectsCount}</span> active projects.
                </p>
            </div>

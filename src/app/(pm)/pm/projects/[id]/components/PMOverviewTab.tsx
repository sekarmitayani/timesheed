            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <CardHeader className="pb-4 border-b border-slate-50">
                        <div>
                            <CardTitle className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                <Activity className="h-4 w-4 text-[#4B7BEC]" /> General Information
                            </CardTitle>
                ...
                <Card className="border-[#E2E8F0] shadow-sm rounded-xl">
                    <CardHeader className="pb-4 border-b border-slate-50">
                        <div>
                            <CardTitle className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                <PieChart className="h-4 w-4 text-[#4B7BEC]" /> Status Overview
                            </CardTitle>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <Card className="border-[#E2E8F0] shadow-sm rounded-xl flex flex-col">
                    <CardHeader className="pb-4 border-b border-slate-50 shrink-0">
                        <div>
                            <CardTitle className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                <Users className="h-4 w-4 text-[#4B7BEC]" /> Team Workload
                            </CardTitle>
                ...
                <Card className="border-[#E2E8F0] shadow-sm rounded-xl flex flex-col">
                    <CardHeader className="pb-4 border-b border-slate-50 shrink-0">
                        <div>
                            <CardTitle className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                <Activity className="h-4 w-4 text-[#4B7BEC]" /> Recent Activity
                            </CardTitle>

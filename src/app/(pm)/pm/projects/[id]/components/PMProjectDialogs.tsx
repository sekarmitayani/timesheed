...
import { Loader2, Trash2, Edit, Calendar, Clock, AlertTriangle } from "lucide-react";
                ...
                <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-[#e2e8f0]">
                    ...
                    <div className="px-6 py-5 space-y-4">
                        <div className="space-y-1.5">
                            ...
                            <Input value={taskForm.title} onChange={e => actions.setTaskForm({ ...taskForm, title: e.target.value })} className="h-10 text-sm" disabled={isSaving} />
                        </div>
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Description</label>
                            <Textarea value={taskForm.description || ""} onChange={e => actions.setTaskForm({ ...taskForm, description: e.target.value })} className="min-h-[100px] text-sm" disabled={isSaving} />
                        </div>

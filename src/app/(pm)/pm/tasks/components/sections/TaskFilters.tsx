...
export function TaskFilters({
    ...
    return (
        <div className="flex flex-col xl:flex-row gap-2.5 items-stretch xl:items-center justify-between shrink-0 mb-1 pt-0.5 px-0.5">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full xl:w-auto flex-1">
                ...
                <div className="relative w-full sm:w-[240px] md:w-[260px] shrink-0 p-0.5">
                    ...
                    <Input
                        ...
                        className="pl-9 h-10 w-full bg-white border-slate-200 text-sm focus-visible:ring-2 focus-visible:ring-[#2568C1] focus-visible:border-[#2568C1] transition-shadow"
                        value={search}

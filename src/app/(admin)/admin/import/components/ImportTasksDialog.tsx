                ...
                <div className="px-4 sm:px-6 pt-3.5 pb-5 overflow-y-auto min-w-0 flex-1 custom-scrollbar">
                    ...
                    {step === "preview" && (
                        <div className="space-y-4">
                            {/* Summary & Filters */}
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-[#f8fafc] border border-[#e2e8f0] p-3 sm:p-3.5 rounded-md text-xs">

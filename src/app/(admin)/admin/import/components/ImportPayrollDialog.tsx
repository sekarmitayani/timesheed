                        ...
                        <>
                            ...
                            <div className="flex items-center justify-end gap-2 sm:gap-3">
                                ...
                                <Button
                                    ...
                                    className="gap-2 bg-gradient-to-r from-[#2568C1] to-[#1a4f99] hover:from-[#1e56a6] hover:to-[#153f7a] shadow-md shadow-[#2568C1]/20 min-w-[120px] text-white text-xs flex-1 sm:flex-none"
                                >
                                    {isUploading ? (
                                        <>

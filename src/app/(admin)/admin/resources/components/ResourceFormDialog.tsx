        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden border-[#e2e8f0] gap-0 rounded-md">
                ...
                <div className="px-6 py-4 border-t border-[#e2e8f0] bg-[#f8fafc] flex justify-end gap-3">
                    <Button variant="ghost" onClick={() => onOpenChange(false)} disabled={isProcessing} className="text-[#64748b] hover:text-[#0f172a] rounded-md">Cancel</Button>
                    <Button className="bg-[#2568C1] hover:bg-[#1e56a6] text-white min-w-[120px] font-semibold rounded-md shadow-sm" onClick={handleSave} disabled={isProcessing}>

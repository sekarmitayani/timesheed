...
export function DashboardHeader({ userName, todoCount }: DashboardHeaderProps) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-slate-500">
                    You have <span className="font-bold text-[#4B7BEC]">{todoCount}</span> tasks in To Do status.
                </p>
            </div>

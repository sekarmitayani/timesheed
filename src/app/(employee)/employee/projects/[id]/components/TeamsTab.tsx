...
export function TeamsTab({ members, totalCount, search, setSearch }: TeamsTabProps) {
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                        ...
                        <Badge variant="secondary" className="text-[10px] font-bold bg-slate-100 text-slate-500 rounded-full">{totalCount}</Badge>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
                {members.map((member) => (
                    <Card
                        key={member.id}
                        className="border-[#E2E8F0] shadow-2xs rounded-md hover:border-[#2568C1]/40 hover:shadow-xs transition-all group cursor-pointer bg-white p-0 py-0 gap-0 overflow-hidden"
                    ...
                    >
                        <CardContent className="p-3.5 sm:p-4 flex items-center gap-3.5">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <span className="text-[10px] sm:text-[11px] font-bold text-[#2568C1] uppercase tracking-wider block leading-tight mt-0.5 truncate">

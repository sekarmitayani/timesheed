...
const statusConfig: Record<string, { label: string; bg: string; icon: React.ReactNode }> = {
    todo: { label: "To Do", bg: "bg-slate-50", icon: <Circle className="h-3.5 w-3.5 text-slate-500" /> },
    in_progress: { label: "In Progress", bg: "bg-blue-50", icon: <PlayCircle className="h-3.5 w-3.5 text-blue-600" /> },

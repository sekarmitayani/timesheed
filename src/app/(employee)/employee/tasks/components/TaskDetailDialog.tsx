                ...
                <div className="flex flex-col lg:flex-row flex-1 overflow-y-auto lg:overflow-hidden min-h-0">
                    ...
                    <div className="w-full lg:w-[280px] lg:shrink-0 bg-slate-50/50 flex flex-col min-w-0 lg:overflow-y-auto custom-scrollbar">
                        <div className="p-4 sm:p-5 lg:p-4 space-y-3.5 h-full">
                            <div>
                                <Button 
                                    className="w-full h-9 gap-2 bg-[#4B7BEC] hover:bg-[#3b60c0] font-bold rounded-md uppercase tracking-wider text-[11px] shadow-sm disabled:opacity-50 disabled:cursor-not-allowed" 
                                    onClick={onClockIn} 
                                    disabled={isClockingIn || !isAssignedToMe}
                                >
                                    {isClockingIn ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <Clock className="h-3.5 w-3.5" />} 

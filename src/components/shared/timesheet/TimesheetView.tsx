...
export function TimesheetView({
    rolePrefix = "timesheet",
    title = "Timesheet Management",
    description = "Monitor and track your work sessions and daily productivity."
}: TimesheetViewProps) {
    const { state, computed, actions } = useTimesheetData(rolePrefix);
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <ActiveSessionBanner 
                ...
                onClockOut={actions.openClockOutDialog}
            ...
            {state.clockOutOpen && (
                <ClockOutDialog 
                    ...
                    clockOutTitle={state.clockOutTitle}
                    setClockOutTitle={actions.setClockOutTitle}
                    ...
                    setSelectedTaskId={actions.setSelectedTaskId}
                    projects={state.projects}
                    projectTasks={state.projectTasks}
                    isLoadingProjectTasks={state.isLoadingProjectTasks}
